...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayout_3.addWidget(self.lbSubjects)
        ...
        self.verticalLayout_3.addWidget(self.lwSubjects)
        self.lbBehaviors = QtWidgets.QLabel(Dialog)
        self.lbBehaviors.setObjectName("lbBehaviors")
        self.verticalLayout_3.addWidget(self.lbBehaviors)
        ...
        self.rb_limit = QtWidgets.QRadioButton(Dialog)
        self.rb_limit.setObjectName("rb_limit")
        self.horizontalLayout_5.addWidget(self.rb_limit)
        self.rb_interval = QtWidgets.QRadioButton(Dialog)
        ...
        self.frm_time_interval = QtWidgets.QFrame(Dialog)
