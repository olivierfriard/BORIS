...
class Ui_converters(object):
    def setupUi(self, converters):
        ...
        self.leName = QtGui.QLineEdit(converters)
        ...
        self.leDescription = QtGui.QLineEdit(converters)
    ...
    def retranslateUi(self, converters):
        ...
        self.label.setText(_translate("converters", "Code", None))
