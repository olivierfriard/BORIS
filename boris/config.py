...
SPECTROGRAM_COLOR_MAPS = ["afmhot", "inferno", "magma", "plasma", "viridis", "gray", "YlOrRd"]
SPECTROGRAM_DEFAULT_COLOR_MAP = "afmhot"
...
SPECTROGRAM_PRE_EMPHASIZE = "SPECTROGRAM_PRE_EMPHASIZE"
SPECTROGRAM_PRE_EMPHASIZE_DEFAULT = False
