...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.le_set_description = QtWidgets.QLineEdit(Dialog)
        self.le_set_description.setObjectName("le_set_description")
        self.verticalLayout.addWidget(self.le_set_description)
