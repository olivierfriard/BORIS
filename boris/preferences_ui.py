...
class Ui_prefDialog(object):
    def setupUi(self, prefDialog):
        ...
        self.lb_hwdec_2 = QtWidgets.QLabel(self.tab)
        self.lb_hwdec_2.setObjectName("lb_hwdec_2")
        self.horizontalLayout_9.addWidget(self.lb_hwdec_2)
    ...
    def retranslateUi(self, prefDialog):
        ...
        self.lb_hwdec_2.setText(_translate("prefDialog", "MPV player hardware video decoding"))
