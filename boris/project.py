        ...
        try:
            ...
            if fileName:
                try:
                    ...
                    QMessageBox.critical(self, programName, f"The file {fileName} does not seem to be behaviors coding map...")
                    return

                if "coding_map_type" not in bcm or bcm["coding_map_type"] != "BORIS behaviors coding map":
                    QMessageBox.critical(self, programName, f"The file {fileName} does not seem to be a BORIS behaviors coding map...")
