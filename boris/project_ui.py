...
class Ui_dlgProject(object):
    def setupUi(self, dlgProject):
        ...
        self.pb_convert_behav_keys_to_lower = QtWidgets.QPushButton(self.tabEthogram)
        ...
        self.pbExclusionMatrix = QtWidgets.QPushButton(self.tabEthogram)
        self.pbExclusionMatrix.setObjectName("pbExclusionMatrix")
        self.verticalLayout_11.addWidget(self.pbExclusionMatrix)
        self.pbImportBehaviorsFromProject = QtWidgets.QPushButton(self.tabEthogram)
        ...
        self.pbImportFromJWatcher = QtWidgets.QPushButton(self.tabEthogram)
        ...
        self.pbImportFromTextFile = QtWidgets.QPushButton(self.tabEthogram)
        self.pbImportFromTextFile.setObjectName("pbImportFromTextFile")
        self.verticalLayout_11.addWidget(self.pbImportFromTextFile)
        self.pb_import_behaviors_from_clipboard = QtWidgets.QPushButton(self.tabEthogram)
