...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cb_date_offset = QtWidgets.QCheckBox(self.layoutWidget)
        self.cb_date_offset.setObjectName("cb_date_offset")
        self.verticalLayout_2.addWidget(self.cb_date_offset)
        self.de_date_offset = QtWidgets.QDateEdit(self.layoutWidget)
        self.de_date_offset.setEnabled(False)
        self.de_date_offset.setCalendarPopup(True)
        self.de_date_offset.setObjectName("de_date_offset")
        self.verticalLayout_2.addWidget(self.de_date_offset)
    ...
    def retranslateUi(self, Form):
        ...
        self.cb_date_offset.setText(_translate("Form", "Date offset"))
        self.de_date_offset.setDisplayFormat(_translate("Form", "yyyy-MM-dd"))
