...
#
# Created: Thu Mar 26 12:34:11 2015
...
class Ui_dlgProject(object):
    def setupUi(self, dlgProject):
        ...
        self.pbAddObservation.setObjectName(_fromUtf8("pbAddObservation"))
        self.verticalLayout_11.addWidget(self.pbAddObservation)
        self.pbClone = QtGui.QPushButton(self.tabConfiguration)
        self.pbClone.setObjectName(_fromUtf8("pbClone"))
        ...
        self.gbSorting.setObjectName(_fromUtf8("gbSorting"))
        ...
        self.cbAlphabeticalOrder.setObjectName(_fromUtf8("cbAlphabeticalOrder"))
        ...
        self.pbLoadSubjects.setObjectName(_fromUtf8("pbLoadSubjects"))
        ...
        self.pbSaveSubjects.setObjectName(_fromUtf8("pbSaveSubjects"))
    ...
    def retranslateUi(self, dlgProject):
        ...
        self.pbAddObservation.setText(_translate("dlgProject", "Add behavior", None))
        self.pbClone.setText(_translate("dlgProject", "Clone behavior", None))
        ...
        self.groupBox.setTitle(_translate("dlgProject", "Sorting", None))
        self.cbAlphabeticalOrder_behavior.setText(_translate("dlgProject", "Alphabetical order", None))
        self.pbUp_behavior.setText(_translate("dlgProject", "Move up", None))
        self.pbDown_behavior.setText(_translate("dlgProject", "Move down", None))
...
"from a BORIS project", None))
        ...
        self.gbSorting.setTitle(_translate("dlgProject", "Sorting", None))
        self.cbAlphabeticalOrder.setText(_translate("dlgProject", "Alphabetical order", None))
        self.pbUp.setText(_translate("dlgProject", "Move up", None))
        self.pbDown.setText(_translate("dlgProject", "Move down", None))
        self.pbImportSubjectsFromProject.setText(_translate("dlgProject", "Import subjects\n"
"from a BORIS project", None))
        self.pbLoadSubjects.setText(_translate("dlgProject", "Load subjects from file", None))
        self.pbSaveSubjects.setText(_translate("dlgProject", "Save subjects to file", None))
        ...
        self.groupBox_2.setTitle(_translate("dlgProject", "Sorting", None))
        self.cbAlphabeticalOrderVar.setText(_translate("dlgProject", "Alphabetical order", None))
        self.pbUpVar.setText(_translate("dlgProject", "Move up", None))
        self.pbDownVar.setText(_translate("dlgProject", "Move down", None))
