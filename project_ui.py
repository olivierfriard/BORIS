...
class Ui_dlgProject(object):
    def setupUi(self, dlgProject):
        ...
        self.leName = QtGui.QLineEdit(self.tab_time_converters)
        self.leName.setObjectName(_fromUtf8("leName"))
        self.horizontalLayout_17.addWidget(self.leName)
        ...
        self.leDescription_2 = QtGui.QLineEdit(self.tab_time_converters)
        self.leDescription_2.setObjectName(_fromUtf8("leDescription_2"))
        self.horizontalLayout_10.addWidget(self.leDescription_2)
...
"from a BORIS project", None))
        ...
        self.tabProject.setTabText(self.tabProject.indexOf(self.tab_time_converters), _translate("dlgProject", "Time converters", None))
