...
#
# Created: Thu Jun 12 14:18:19 2014
...
class Ui_dlgProject(object):
    ...
    def retranslateUi(self, dlgProject):
        ...
        self.rbHMS.setText(QtGui.QApplication.translate("dlgProject", "hh:mm:ss.mss", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.twBehaviors.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("dlgProject", "Exclusion", None, QtGui.QApplication.UnicodeUTF8))
        self.twBehaviors.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("dlgProject", "Coding map", None, QtGui.QApplication.UnicodeUTF8))
...
"from a BORIS project", None, QtGui.QApplication.UnicodeUTF8))
        self.pbImportFromJWatcher.setText(QtGui.QApplication.translate("dlgProject", "Import from JWatcher", None, QtGui.QApplication.UnicodeUTF8))
        self.lbObservationsState.setText(QtGui.QApplication.translate("dlgProject", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
        self.tabProject.setTabText(self.tabProject.indexOf(self.tabConfiguration), QtGui.QApplication.translate("dlgProject", "Ethogram", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.twSubjects.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("dlgProject", "Description", None, QtGui.QApplication.UnicodeUTF8))
