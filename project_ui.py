...
#
# Created: Thu Mar 20 21:07:35 2014
...
class Ui_dlgProject(object):
    def setupUi(self, dlgProject):
        ...
        self.cbAlphabeticalOrder_behavior_2 = QtGui.QCheckBox(self.groupBox_2)
        self.cbAlphabeticalOrder_behavior_2.setObjectName("cbAlphabeticalOrder_behavior_2")
        self.verticalLayout_17.addWidget(self.cbAlphabeticalOrder_behavior_2)
        self.pbUp_behavior_2 = QtGui.QPushButton(self.groupBox_2)
        self.pbUp_behavior_2.setObjectName("pbUp_behavior_2")
        self.verticalLayout_17.addWidget(self.pbUp_behavior_2)
        self.pbDown_behavior_2 = QtGui.QPushButton(self.groupBox_2)
        self.pbDown_behavior_2.setObjectName("pbDown_behavior_2")
        self.verticalLayout_17.addWidget(self.pbDown_behavior_2)
        ...
        self.pbImportBehaviorsFromProject_2 = QtGui.QPushButton(self.tabIndependentVariables)
        self.pbImportBehaviorsFromProject_2.setObjectName("pbImportBehaviorsFromProject_2")
        self.verticalLayout_12.addWidget(self.pbImportBehaviorsFromProject_2)
        self.pbLoadConfiguration_2 = QtGui.QPushButton(self.tabIndependentVariables)
        self.pbLoadConfiguration_2.setObjectName("pbLoadConfiguration_2")
        self.verticalLayout_12.addWidget(self.pbLoadConfiguration_2)
        self.pbSaveConfiguration_2 = QtGui.QPushButton(self.tabIndependentVariables)
        self.pbSaveConfiguration_2.setObjectName("pbSaveConfiguration_2")
        self.verticalLayout_12.addWidget(self.pbSaveConfiguration_2)
    ...
    def retranslateUi(self, dlgProject):
        ...
        self.cbAlphabeticalOrder_behavior_2.setText(QtGui.QApplication.translate("dlgProject", "Alphabetical order", None, QtGui.QApplication.UnicodeUTF8))
        self.pbUp_behavior_2.setText(QtGui.QApplication.translate("dlgProject", "Move up", None, QtGui.QApplication.UnicodeUTF8))
        self.pbDown_behavior_2.setText(QtGui.QApplication.translate("dlgProject", "Move down", None, QtGui.QApplication.UnicodeUTF8))
        self.pbImportBehaviorsFromProject_2.setText(QtGui.QApplication.translate("dlgProject", "Import from project", None, QtGui.QApplication.UnicodeUTF8))
        self.pbLoadConfiguration_2.setText(QtGui.QApplication.translate("dlgProject", "Load variables from file", None, QtGui.QApplication.UnicodeUTF8))
        self.pbSaveConfiguration_2.setText(QtGui.QApplication.translate("dlgProject", "Save variables to file", None, QtGui.QApplication.UnicodeUTF8))
