...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_logo = QtGui.QWidget(self.centralwidget)
        self.w_logo.setObjectName(_fromUtf8("w_logo"))
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.w_logo)
        self.verticalLayout_8.setMargin(0)
        self.verticalLayout_8.setObjectName(_fromUtf8("verticalLayout_8"))
        self.verticalLayout_6 = QtGui.QVBoxLayout()
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.lbLogoBoris = QtGui.QLabel(self.w_logo)
        ...
        self.lbLogoUnito = QtGui.QLabel(self.w_logo)
        ...
        self.w_obs_info = QtGui.QWidget(self.centralwidget)
        self.w_obs_info.setEnabled(True)
        self.w_obs_info.setObjectName(_fromUtf8("w_obs_info"))
        self.verticalLayout_10 = QtGui.QVBoxLayout(self.w_obs_info)
        self.verticalLayout_10.setMargin(0)
        self.verticalLayout_10.setObjectName(_fromUtf8("verticalLayout_10"))
        self.verticalLayout_9 = QtGui.QVBoxLayout()
        self.verticalLayout_9.setObjectName(_fromUtf8("verticalLayout_9"))
        self.lb_current_media_time = QtGui.QLabel(self.w_obs_info)
        ...
        self.lbFocalSubject = QtGui.QLabel(self.w_obs_info)
        ...
        self.lbCurrentStates = QtGui.QLabel(self.w_obs_info)
        ...
        self.w_live = QtGui.QWidget(self.w_obs_info)
        self.w_live.setObjectName(_fromUtf8("w_live"))
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.w_live)
        self.verticalLayout_11.setMargin(0)
        self.verticalLayout_11.setObjectName(_fromUtf8("verticalLayout_11"))
        self.pb_live_obs = QtGui.QPushButton(self.w_live)
        self.pb_live_obs.setObjectName(_fromUtf8("pb_live_obs"))
        ...
        self.menuImport_project = QtGui.QMenu(self.menuFile)
        self.menuImport_project.setObjectName(_fromUtf8("menuImport_project"))
        self.menuObservations = QtGui.QMenu(self.menubar)
        self.menuObservations.setObjectName(_fromUtf8("menuObservations"))
        self.menuCreate_transitions_matrix = QtGui.QMenu(self.menuObservations)
        self.menuCreate_transitions_matrix.setObjectName(_fromUtf8("menuCreate_transitions_matrix"))
        ...
        self.menuPlot_events = QtGui.QMenu(self.menuAnalyze)
        self.menuPlot_events.setObjectName(_fromUtf8("menuPlot_events"))
        self.menuInter_rater_reliability = QtGui.QMenu(self.menuAnalyze)
        self.menuInter_rater_reliability.setObjectName(_fromUtf8("menuInter_rater_reliability"))
        self.menuPlayback = QtGui.QMenu(self.menubar)
        self.menuPlayback.setObjectName(_fromUtf8("menuPlayback"))
        self.menuZoom1 = QtGui.QMenu(self.menuPlayback)
        self.menuZoom1.setObjectName(_fromUtf8("menuZoom1"))
        self.menuZoom2 = QtGui.QMenu(self.menuPlayback)
        self.menuZoom2.setObjectName(_fromUtf8("menuZoom2"))
        ...
        self.menu_coding_map_creator = QtGui.QMenu(self.menuTools)
        self.menu_coding_map_creator.setObjectName(_fromUtf8("menu_coding_map_creator"))
        ...
        self.dwSubjects.setFeatures(QtGui.QDockWidget.DockWidgetFloatable|QtGui.QDockWidget.DockWidgetMovable)
        ...
        self.actionCoding_pad = QtGui.QAction(MainWindow)
        self.actionCoding_pad.setObjectName(_fromUtf8("actionCoding_pad"))
        ...
        self.actionAll_transitions = QtGui.QAction(MainWindow)
        self.actionAll_transitions.setObjectName(_fromUtf8("actionAll_transitions"))
        self.actionNumber_of_transitions = QtGui.QAction(MainWindow)
        self.actionNumber_of_transitions.setObjectName(_fromUtf8("actionNumber_of_transitions"))
        self.actionFrequencies_of_transitions_after_behaviors = QtGui.QAction(MainWindow)
        self.actionFrequencies_of_transitions_after_behaviors.setObjectName(_fromUtf8("actionFrequencies_of_transitions_after_behaviors"))
        self.actionFind_replace_events = QtGui.QAction(MainWindow)
        ...
        self.actionZoom1_1_1 = QtGui.QAction(MainWindow)
        self.actionZoom1_1_1.setCheckable(True)
        self.actionZoom1_1_1.setObjectName(_fromUtf8("actionZoom1_1_1"))
        self.actionZoom1_2_1 = QtGui.QAction(MainWindow)
        self.actionZoom1_2_1.setCheckable(True)
        self.actionZoom1_2_1.setObjectName(_fromUtf8("actionZoom1_2_1"))
        self.actionZoom1_1_2 = QtGui.QAction(MainWindow)
        self.actionZoom1_1_2.setCheckable(True)
        self.actionZoom1_1_2.setObjectName(_fromUtf8("actionZoom1_1_2"))
        self.actionZoom1_1_4 = QtGui.QAction(MainWindow)
        self.actionZoom1_1_4.setCheckable(True)
        self.actionZoom1_1_4.setObjectName(_fromUtf8("actionZoom1_1_4"))
        self.actionZoom1_fitwindow = QtGui.QAction(MainWindow)
        self.actionZoom1_fitwindow.setCheckable(True)
        self.actionZoom1_fitwindow.setObjectName(_fromUtf8("actionZoom1_fitwindow"))
        self.actionZoom2_fitwindow = QtGui.QAction(MainWindow)
        self.actionZoom2_fitwindow.setCheckable(True)
        self.actionZoom2_fitwindow.setObjectName(_fromUtf8("actionZoom2_fitwindow"))
        self.actionZoom2_1_4 = QtGui.QAction(MainWindow)
        self.actionZoom2_1_4.setCheckable(True)
        self.actionZoom2_1_4.setObjectName(_fromUtf8("actionZoom2_1_4"))
        self.actionZoom2_1_2 = QtGui.QAction(MainWindow)
        self.actionZoom2_1_2.setCheckable(True)
        self.actionZoom2_1_2.setObjectName(_fromUtf8("actionZoom2_1_2"))
        self.actionZoom2_1_1 = QtGui.QAction(MainWindow)
        self.actionZoom2_1_1.setCheckable(True)
        self.actionZoom2_1_1.setObjectName(_fromUtf8("actionZoom2_1_1"))
        ...
        self.actionBehaviors_coding_map = QtGui.QAction(MainWindow)
        self.actionBehaviors_coding_map.setObjectName(_fromUtf8("actionBehaviors_coding_map"))
        self.action_create_behaviors_coding_map = QtGui.QAction(MainWindow)
        self.action_create_behaviors_coding_map.setObjectName(_fromUtf8("action_create_behaviors_coding_map"))
        self.action_create_modifiers_coding_map = QtGui.QAction(MainWindow)
        self.action_create_modifiers_coding_map.setObjectName(_fromUtf8("action_create_modifiers_coding_map"))
        self.actionPlot_events1 = QtGui.QAction(MainWindow)
        self.actionPlot_events1.setObjectName(_fromUtf8("actionPlot_events1"))
        self.actionPlot_events2 = QtGui.QAction(MainWindow)
        ...
        self.actionShow_data_files = QtGui.QAction(MainWindow)
        self.actionShow_data_files.setObjectName(_fromUtf8("actionShow_data_files"))
        self.actionConverters_manager = QtGui.QAction(MainWindow)
        self.actionConverters_manager.setObjectName(_fromUtf8("actionConverters_manager"))
        self.actionView_observation = QtGui.QAction(MainWindow)
        ...
        self.actionExportEvents_2 = QtGui.QAction(MainWindow)
        ...
        self.actionFilter_events = QtGui.QAction(MainWindow)
        ...
        self.actionCopy_events = QtGui.QAction(MainWindow)
        self.actionCopy_events.setObjectName(_fromUtf8("actionCopy_events"))
        self.actionPaste_events = QtGui.QAction(MainWindow)
        self.actionPaste_events.setObjectName(_fromUtf8("actionPaste_events"))
        self.actionNoldus_Observer_template = QtGui.QAction(MainWindow)
        self.actionNoldus_Observer_template.setObjectName(_fromUtf8("actionNoldus_Observer_template"))
        self.actionExplore_project = QtGui.QAction(MainWindow)
        self.actionExplore_project.setObjectName(_fromUtf8("actionExplore_project"))
        self.actionShow_the_sound_waveform = QtGui.QAction(MainWindow)
        self.actionShow_the_sound_waveform.setObjectName(_fromUtf8("actionShow_the_sound_waveform"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_current_media_time.setText(_translate("MainWindow", "lb_current_media_time", None))
        ...
        self.pb_live_obs.setText(_translate("MainWindow", "PushButton", None))
        self.menuHelp.setTitle(_translate("MainWindow", "Help", None))
        self.menuFile.setTitle(_translate("MainWindow", "File", None))
        self.menuRecent_projects.setTitle(_translate("MainWindow", "Recent projects", None))
        self.menuImport_project.setTitle(_translate("MainWindow", "Import project from...", None))
        self.menuObservations.setTitle(_translate("MainWindow", "Observations", None))
        self.menuCreate_transitions_matrix.setTitle(_translate("MainWindow", "Create transitions matrix", None))
        ...
        self.menuPlot_events.setTitle(_translate("MainWindow", "Plot events", None))
        self.menuInter_rater_reliability.setTitle(_translate("MainWindow", "Inter-rater reliability", None))
        self.menuPlayback.setTitle(_translate("MainWindow", "Playback", None))
        self.menuZoom1.setTitle(_translate("MainWindow", "Zoom player #1", None))
        self.menuZoom2.setTitle(_translate("MainWindow", "Zoom player #2", None))
        self.menuTools.setTitle(_translate("MainWindow", "Tools", None))
        self.menuTransitions_flow_diagram.setTitle(_translate("MainWindow", "Transitions flow diagram", None))
        self.menu_coding_map_creator.setTitle(_translate("MainWindow", "Create a coding map", None))
        ...
        self.actionAdd_event.setShortcut(_translate("MainWindow", "Ctrl+A", None))
        ...
        self.actionExportEventString.setText(_translate("MainWindow", "as behavioural strings", None))
        ...
        self.actionShow_spectrogram.setText(_translate("MainWindow", "Show the sound spectrogram", None))
        self.actionExport_events_as_Praat_TextGrid.setText(_translate("MainWindow", "as Praat TextGrid", None))
        ...
        self.actionExport_aggregated_events.setText(_translate("MainWindow", "aggregated events", None))
        self.actionCoding_pad.setText(_translate("MainWindow", "Coding pad", None))
        self.actionTime_budget_by_behaviors_category.setText(_translate("MainWindow", "Time budget by behavioral category", None))
        ...
        self.actionZoom1_1_1.setText(_translate("MainWindow", "1:1 Original", None))
        self.actionZoom1_2_1.setText(_translate("MainWindow", "2:1 Double", None))
        self.actionZoom1_1_2.setText(_translate("MainWindow", "1:2 Half", None))
        self.actionZoom1_1_4.setText(_translate("MainWindow", "1:4 Quarter", None))
        self.actionZoom1_fitwindow.setText(_translate("MainWindow", "Fit to window", None))
        self.actionZoom2_fitwindow.setText(_translate("MainWindow", "Fit to window", None))
        self.actionZoom2_1_4.setText(_translate("MainWindow", "1:4 Quarter", None))
        ...
        self.actionBehaviors_coding_map.setText(_translate("MainWindow", "Behaviors coding map", None))
        self.action_create_behaviors_coding_map.setText(_translate("MainWindow", "for behaviors", None))
        ...
        self.actionShow_data_files.setText(_translate("MainWindow", "Show data files", None))
        ...
        self.actionEdit_event_time.setText(_translate("MainWindow", "Shift time of selected event(s)", None))
        self.actionCopy_events.setText(_translate("MainWindow", "Copy events", None))
        self.actionPaste_events.setText(_translate("MainWindow", "Paste events", None))
        self.actionNoldus_Observer_template.setText(_translate("MainWindow", "Noldus Observer XT template", None))
        self.actionExplore_project.setText(_translate("MainWindow", "Explore project", None))
        self.actionShow_the_sound_waveform.setText(_translate("MainWindow", "Show the sound waveform", None))
