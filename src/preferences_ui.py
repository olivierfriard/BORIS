...
class Ui_prefDialog(object):
    def setupUi(self, prefDialog):
        ...
        self.pb_reset_frames_memory = QtWidgets.QPushButton(self.tab_3)
        self.pb_reset_frames_memory.setObjectName("pb_reset_frames_memory")
        self.horizontalLayout_11.addWidget(self.pb_reset_frames_memory)
    ...
    def retranslateUi(self, prefDialog):
        ...
        self.pb_reset_frames_memory.setText(_translate("prefDialog", "Reset frames memory"))
