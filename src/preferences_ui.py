...
class Ui_prefDialog(object):
    def setupUi(self, prefDialog):
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.cb_display_subtitles)
        ...
        self.rb_save_frames_in_mem.setGeometry(QtCore.QRect(20, 20, 231, 23))
        ...
        self.rb_save_frames_on_disk.setGeometry(QtCore.QRect(20, 160, 201, 23))
        self.rb_save_frames_on_disk.setObjectName("rb_save_frames_on_disk")
        self.lb_memory_frames = QtWidgets.QLabel(self.tab_3)
        self.lb_memory_frames.setGeometry(QtCore.QRect(40, 60, 201, 17))
        self.lb_memory_frames.setObjectName("lb_memory_frames")
        self.sb_frames_memory_size = QtWidgets.QSpinBox(self.tab_3)
        self.sb_frames_memory_size.setGeometry(QtCore.QRect(240, 50, 101, 26))
        self.sb_frames_memory_size.setMinimum(1)
        self.sb_frames_memory_size.setMaximum(1000)
        self.sb_frames_memory_size.setSingleStep(10)
        self.sb_frames_memory_size.setProperty("value", 200)
        self.sb_frames_memory_size.setObjectName("sb_frames_memory_size")
        self.widget = QtWidgets.QWidget(self.tab_3)
        self.widget.setGeometry(QtCore.QRect(20, 190, 461, 35))
        self.widget.setObjectName("widget")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.lb_resize_frame = QtWidgets.QLabel(self.widget)
        self.lb_resize_frame.setEnabled(False)
        ...
        self.sbFrameResize = QtWidgets.QSpinBox(self.widget)
        self.sbFrameResize.setEnabled(False)
        ...
        self.widget1.setGeometry(QtCore.QRect(20, 230, 389, 27))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.lb_bitmap_quality = QtWidgets.QLabel(self.widget1)
        ...
        self.cbFrameBitmapFormat = QtWidgets.QComboBox(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(20, 260, 196, 28))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.widget2)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.lb_cache_size = QtWidgets.QLabel(self.widget2)
        self.lb_cache_size.setEnabled(False)
        self.lb_cache_size.setObjectName("lb_cache_size")
        self.horizontalLayout_9.addWidget(self.lb_cache_size)
        self.sb_fbf_cache_size = QtWidgets.QSpinBox(self.widget2)
        self.sb_fbf_cache_size.setEnabled(False)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 319, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, prefDialog):
        ...
        self.lb_memory_frames.setText(_translate("prefDialog", "Memory dedicated to frames (Mb)"))
        self.lb_resize_frame.setText(_translate("prefDialog", "Resize frame (horizontal number of pixels). The aspect ratio will be maintained"))
