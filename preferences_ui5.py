...
class Ui_prefDialog(object):
    def setupUi(self, prefDialog):
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.sbBeepEvery)
        self.cbEmbedPlayer = QtWidgets.QCheckBox(self.tab)
        self.cbEmbedPlayer.setObjectName("cbEmbedPlayer")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.cbEmbedPlayer)
