...
class Ui_dlgProject(object):
    def setupUi(self, dlgProject):
        ...
        self.leName = QtWidgets.QLineEdit(self.tab_time_converters)
        ...
        self.leDescription_2 = QtWidgets.QLineEdit(self.tab_time_converters)
        self.leDescription_2.setObjectName("leDescription_2")
